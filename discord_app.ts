...
export type DiscordAppHandler<
  ...
  SubcommandName
    extends (A extends ChatInputAppGroupsEnvelope
      ? keyof A["groups"][GroupName]["subcommands"]
      : A extends ChatInputAppSubcommandsEnvelope ? keyof A["subcommands"]
      : never),
  GroupName
    extends (A extends ChatInputAppGroupsEnvelope ? keyof A["groups"] : never),
